...
namespace Hgabka\KunstmaanBannerBundle\Controller;

use Hgabka\KunstmaanBannerBundle\AdminList\BannerAdminListConfigurator;
 ...
 */
class BannerAdminListController extends AdminListController
{
    /**
